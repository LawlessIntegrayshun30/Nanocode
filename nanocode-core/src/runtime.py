...
class Runtime:
    ...
    def load_state(
        ...
        *,
        ...
        program_digest: str | None = None,
        state_program_digest: str | None = None,
    ) -> str:
        ...
        if program_digest is not None:
            self.program_digest = program_digest
        if state_program_digest is not None:
            if self.program_digest is not None and state_program_digest != self.program_digest:
                raise ValueError(
                    "Program digest mismatch between loaded state and current program"
                )
            self.program_digest = state_program_digest
