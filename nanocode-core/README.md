...
When resuming from a snapshot, the runtime will honor the persisted scheduler, walk/strict flags, and other metadata unless you explicitly override them (for example, with `--no-walk-children`).
